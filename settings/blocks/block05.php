...
$name = 'theme_almondb/block05desing';
$title = get_string('block05desing', 'theme_almondb');
$description = get_string('block05desingdesc', 'theme_almondb');
$default = 1;
$options = array();
for ($i = 1; $i < 2; $i++) {
     $options[$i] = $i;
...
for ($i = 1; $i <= 3; $i++) {
     ...
     $title = get_string('block05icon', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block05title', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block05caption', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block05link', 'theme_almondb', array('block' => $i));
