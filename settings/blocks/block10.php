...
$name = 'theme_almondb/block10desing';
$title = get_string('block10desing', 'theme_almondb');
$description = get_string('block10desingdesc', 'theme_almondb');
$default = 1;
$options = array();
for ($i = 1; $i < 3; $i++) {
     $options[$i] = $i;
...
for ($i = 1; $i < $count + 1; $i++) {
     ...
     $title = get_string('sliderimageblock10img', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block10name', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block10job', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block10caption', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block10link', 'theme_almondb', array('block' => $i));
