...
for ($i = 1; $i < $count + 1; $i++) {
     ...
     $title = get_string('block02icon', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('sliderimageblock02img', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block02title', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block02caption', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block02button', 'theme_almondb', array('block' => $i));
     ...
     $title = get_string('block02buttonlink', 'theme_almondb', array('block' => $i));
